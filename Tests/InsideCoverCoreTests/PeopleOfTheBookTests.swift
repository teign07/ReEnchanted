...
final class PeopleOfTheBookTests: XCTestCase {
    ...
    func testBookAsksBeforeBelievingRelationshipContext() throws {
        ...
        XCTAssertTrue(question.payload.body.contains("I won't smuggle it into their chapter without asking you"))
        XCTAssertTrue(question.payload.body.contains("Say yes and I ink it. Say no and the clue goes back under the rug."))
