...
final class PeopleOfTheBookTests: XCTestCase {
    ...
    func testBookAsksBeforeBelievingRelationshipContext() throws {
        ...
        XCTAssertTrue(question.payload.body.contains("I caught it before it crawled into their chapter"), question.payload.body)
        XCTAssertTrue(question.payload.body.contains("Say yes and I ink it. Say no and I shove it back under the rug."), question.payload.body)
