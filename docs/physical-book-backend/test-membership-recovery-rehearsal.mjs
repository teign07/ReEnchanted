...
test('rehearsal restricts membership, device, email, environment and expiry', () => {
 ...
 const scope={...payload,recipient:'snow.potions@gmail.com',expiresAt:now+1800000};
 const env={CHECKOUT_MODE:'test',MEMBERSHIP_RECOVERY_REHEARSAL_JSON:JSON.stringify(scope)};
